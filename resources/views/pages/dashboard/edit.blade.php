    ...
    <section x-data="calc()" x-effect="setEndDate()" class="w-full lg:w-4/5">
        ...
        <div class="p-8 mt-6 lg:mt-0 leading-normal rounded shadow bg-white">
            ...
            <div class="md:flex mb-6">
                ...
                <div class="md:w-2/3">
                    @php
                        ...
                        $ambil = "mandiri";
                    @endphp
                    <select name="tipe_pengambilan" class="form-input block w-full focus:bg-white" id="my-textfield" x-model="pickup" {{ $pemesanans->status != 'waiting' ? 'readonly' : '' }}>
            ...
            <div class="md:flex mb-6">
                ...
                <div class="md:w-2/3">
                    <input name="jumlah" class="form-input block w-full focus:bg-white" id="jumlah my-textfield" type="number" placeholder="jumlah kilogram" x-model="quantity" @input="update_total" @change="reset_start_date" required {{ $pemesanans->status != 'waiting' ? 'readonly' : '' }}>
