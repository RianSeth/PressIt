    ...
    <div class="fixed flex justify-center items-center w-full h-full bg-black/50">
        ...
        <form action="{{ route('createstore') }}" method="post" enctype="multipart/form-data" class="fixed overflow-auto h-5/6 w-3/4 p-8 leading-normal rounded shadow bg-white"> {{-- route(booking.store) --}}
            ...
            <div>
                ...
                <div class="md:flex mb-6">
                    ...
                    <div class="md:w-2/3">
                        ...
                        <div x-show="!startDate" class="text-red-500 mt-2">Anda belum memasukkan tanggal pemesanan!</div>
                    </div>
                </div>
                ...
                <div class="md:flex mb-6">
                    ...
                    <div class="md:w-2/3">
                        ...
                        <div x-show="!pickup" class="text-red-500 mt-2">Anda belum memasukkan tipe pengantaran!</div>
                    </div>
                </div>
            ...
            <div class="fixed bottom-9">
                <button x-bind:disabled="!startDate || !pickup" class="shadow bg-yellow-700 hover:bg-yellow-500 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded mr-4">
                    Kirim
                </button>
